    ...
    <div class="w-full flex flex-col lg:flex-row px-8 md:px-10 gap-10 lg:gap-20 lg:py-20">
      ...
      <div class="w-full flex flex-col">
        ...
        data-aos-easing='ease-in-out' class="text-lg text-black dark:text-gray-300 leading-10 justify-start">
          I am a highly skilled Frontend Software Developer with 3 years of hands-on experience in developing robust websites and applications using React.js (JavaScript) and FastAPI. My expertise extends to various JavaScript technologies, including jQuery, Node.js and Veu.js. I have been an integral part of successful projects, contributing to their design, development, and deployment phases from conceptualization to implementation. 
        </p>
